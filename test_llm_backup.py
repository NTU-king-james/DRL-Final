...
class LLMAgent:
    ...
    def act(self, global_state_nl, avail_actions_list, n_agents, env_info):
        ...
        if self.verbose:
            ...
            print(f"LLMAgent final selected actions: IDs={chosen_actions}, Descriptions={action_descs_final}")        return chosen_actions
...
def run_smac_with_agents(llm_agent, qmix_agent, map_name, num_episodes, max_steps_per_episode, verbose_env=False, render=False):
